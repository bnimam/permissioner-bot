...
def chatbot(net, sess, chars, vocab, max_length, beam_width, relevance, temperature, topn):
    ...
    while True:
        ...
        if not user_command_entered:
            states = forward_text(net, sess, states, relevance, vocab, sanitize_text(
                vocab, "> " + user_input + "\n>"))
            ...
            for i, char_token in enumerate(computer_response_generator):
                ...
                states = forward_text(
                    net, sess, states, relevance, vocab, chars[char_token])
                if i >= max_length:
                    break
            states = forward_text(
                net, sess, states, relevance, vocab, sanitize_text(vocab, "\n> "))
